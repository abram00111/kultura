...
$('.abr-table').each(function () {
  ...
  $(this).addClass('table' + nubmer_table); //Если в настройках включена функция поиска, и таблица НЕ содержит класс "abr-off-search"
...
function getPagination(table) {
  ...
  $('#maxRows').on('change', function (evt) {
    ...
    limitPagging();
  }).val(5).change(); // end of on select change
  // END OF PAGINATION
}
