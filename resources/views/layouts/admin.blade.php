    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="/admin" class="brand-link">
            <img src="img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Культура для школ</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <a href="/user" class="d-block">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="storage/img/avatar/mini/{{\Illuminate\Support\Facades\Auth::user()->avatar}}"
                             class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        {{\Illuminate\Support\Facades\Auth::user()->short_fio}}
                    </div>
                </div>
            </a>
